 ...
 * @Date:   2017-10-18T16:43:07+02:00
...
declare module 'seamless-immutable' {
  declare type Immutable<T> = T & {
    ...
    replace<U: T>(u: U, opts?: { deep: boolean }): Immutable<T>,
  ...
  declare type ImmutableStatic = {
    ...
    replace<T, U: T>(t: Immutable<T>, u: U, opts?: { deep: boolean }): Immutable<T>,
    ...
    asMutable<T>(t: Immutable<T>, opts?: { deep: boolean }): T,
